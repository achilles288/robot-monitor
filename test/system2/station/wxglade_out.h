...
extern long ID_B74880;
extern long ID_B115200;
// end wxGlade
...
protected:
    ...
    wxStaticText* lblAccelX;
    wxStaticText* lblAccelY;
    wxStaticText* lblAccelZ;
    ...
    wxButton* btnCaliAccel;
    wxButton* btnCaliGyro;
    wxButton* btnCaliMag;
    wxTextCtrl* txtEcho;
