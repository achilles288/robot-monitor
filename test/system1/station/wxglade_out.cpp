// -*- C++ -*-
//
// generated by wxGlade 0.9.4 on Mon Jun 14 18:44:45 2021
//
    ...
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    /*lblPot1 = new wxStaticText(this, wxID_ANY, wxT("pot1"));
    gaugePot1 = new wxGauge(this, wxID_ANY, 10);
    chkBtn1 = new wxCheckBox(this, wxID_ANY, wxT("Button 1"));
    lblLed1 = new wxStaticText(this, wxID_ANY, wxT("LED 1"));
    sliderLed1 = new wxSlider(this, wxID_ANY, 0, 0, 10);
    chkLed2 = new wxCheckBox(this, wxID_ANY, wxT("LED 2"));
    btnCmd1 = new wxButton(this, wxID_ANY, wxT("Command 1"));
...
void MyFrame::set_properties()
{
    ...
    SetIcon(_icon);
    gaugePot1->SetMinSize(wxSize(120, 28));
    chkBtn1->Enable(0);
    sliderLed1->SetMinSize(wxSize(120, 34));
    // end wxGlade
}
...
void MyFrame::do_layout()
{
    ...
    sizer_5->Add(lblPot1, 0, 0, 0);
    sizer_5->Add(gaugePot1, 0, wxBOTTOM|wxEXPAND, 7);
    sizer_3->Add(sizer_5, 0, wxEXPAND, 0);
    sizer_3->Add(chkBtn1, 0, 0, 0);
    sizer_2->Add(sizer_3, 1, wxALL|wxEXPAND, 5);
    sizer_6->Add(lblLed1, 0, 0, 0);
    sizer_6->Add(sliderLed1, 0, wxEXPAND, 0);
    sizer_4->Add(sizer_6, 0, wxEXPAND, 0);
    sizer_4->Add(chkLed2, 0, 0, 0);
    sizer_4->Add(btnCmd1, 0, 0, 0);
